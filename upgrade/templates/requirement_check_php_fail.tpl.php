...
<table cellpadding="2" cellspacing="2">
	...
	<tbody>
		<tr style="background-color: #FFF;">
			...
			<td class="req">PHP Version 5.2.3+</td>
			<td class="setting">PHP <?php echo phpversion(); ?></td>
		</tr>

		<tr style="background-color: #FFF;">
			<td class="result">---</td>
			<td class="req">PHP safe_mode OFF</td>
		...
		<tr>
			<th class="heading3" colspan="3">Server checked for at least "one" of the following:</th>
		</tr>
		<tr style="background-color: #FFF;">
		...
		<tr style="background-color: #FFF;">
			<td class="result">---</td>
			<td class="req">Zend Optimizer</td>
