...
class AuctionsUpgrade extends Upgrade {
	...
	function rewriteTemplates() {
		...
		while($row = $result->FetchRow()) {
			...
			$code = preg_replace("/index\.php\?a=(1[0-9]{3})/e", "'index.php?a='.($1 > 1000 ? $1 - 1000 : $1)", $code);
			$code = preg_replace("/index\.php\?a=28&b=(1[0-9]{4})/e", "'index.php?a=28&b='.($1 > 10000 ? $1 - 10000 : $1)", $code);
	...
	function rewritePages() {
		...
		while($row = $result->FetchRow()) {
			...
			$logged_in = preg_replace("/index\.php\?a=(1[0-9]{3})/e", "'index.php?a='.($1 > 1000 ? $1 - 1000 : $1)", $logged_in);
			$logged_in = preg_replace("/index\.php\?a=28&b=(1[0-9]{4})/e", "'index.php?a=28&b='.($1 > 10000 ? $1 - 10000 : $1)", $logged_in);

			$logged_out = preg_replace("/index\.php\?a=(1[0-9]{3})/e", "'index.php?a='.($1 > 1000 ? $1 - 1000 : $1)", $logged_out);
			$logged_out = preg_replace("/index\.php\?a=28&b=(1[0-9]{4})/e", "'index.php?a=28&b='.($1 > 10000 ? $1 - 10000 : $1)",	$logged_out);
	...
	function rewriteText() {
		...
		while($row = $result->FetchRow()) {
			...
			$text = preg_replace("/index\.php\?a=(1[0-9]{3})/e", "'index.php?a='.($1 > 1000 ? $1 - 1000 : $1)", $text);
			$text = preg_replace("/index\.php\?a=28&b=(1[0-9]{4})/e", "'index.php?a=28&b='.($1 > 10000 ? $1 - 10000 : $1)", $text);
