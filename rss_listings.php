 ...
 * 		for example: "rss_listings.php?geoNavRegion=region52" to display only listings in region 52
 * specific region value (e.g. "region52") - display only listings from the given region 
 * 
 * 
 */
 ...
 * 
 * Default is 0 (do not use lead image)
 */
$feed->leadImage = 0;
