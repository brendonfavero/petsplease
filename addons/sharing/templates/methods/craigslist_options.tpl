...
<ul class="button_list">
	<li><input type="submit" class="button" value="{$msgs.craigslist_preview_btn}" onclick="$('responseType').value='preview'" /></li>
	<li><input type="submit" class="button" value="{$msgs.craigslist_html_btn}" onclick="$('responseType').value='html'" /></li>
</ul>