	...
	public function init_text($language_id)
	{
		return array (
			...
			'fb_merge_page_instructions' => array (
				...
				'desc' => '',
				'type' => 'textarea',
				'default' => 'The Facebook account is already linked to another user in the system. You will not be able to continue until you choose to merge the accounts together, cancel the link, or <a href="{$classifieds_file_name}?a=17" class="mini_button">log out</a>.'
			),
