...
class user_page_1_bodyImportItem extends geoImportItem
{
	private $_pageNum = 1;
	protected $_name = 'Storefront: User Page 1 Body';
	protected $_description = 'The page body for user page 1. HTML is allowed.';
	
	public $requires; // set in constructor
