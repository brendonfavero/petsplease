...
class user_page_3_titleImportItem extends geoImportItem
{
	private $_pageNum = 3;
	protected $_name = 'Storefront: User Page 3 Title';
	protected $_description = 'The name and link text for user page 3';
