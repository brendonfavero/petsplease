...
class user_page_2_bodyImportItem extends geoImportItem
{
	private $_pageNum = 2;
	protected $_name = 'Storefront: User Page 2 Body';
	protected $_description = 'The page body for user page 2. HTML is allowed.';
