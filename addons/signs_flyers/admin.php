...
class addon_signs_flyers_admin extends addon_signs_flyers_info {
	...
	function init_pages () {
			...
			menu_page::addonAddPage('addon_signs','','Signs Setup','signs_flyers',$this->icon_image);
			menu_page::addonAddPage('addon_flyers','','Flyers Setup','signs_flyers',$this->icon_image);		
	}
	...
	function display_addon_signs () 
	{
		...
		elseif ($result->RecordCount() == 1)
		{
			...
			if (!$this->admin_site->admin_demo())$this->admin_site->body .= "<form action=index.php?mc=listing_setup&page=addon_signs method=post>\n";
			$this->admin_site->body .= "
<fieldset>
<legend>Current Image Choices for Seller</legend>
<table cellpadding=3 cellspacing=0 border=0 width=100% align=center class=" . $this->admin_site->get_row_color() . " >\n";
			...
			$this->admin_site->body .= "<tr>\n\t<td class=col_hdr_left><b>Image Title (displayed to seller)</b></td><td class=col_hdr_left colspan=\"2\"><b>Image location</b></td></tr>\n";
...
<table cellpadding=3 cellspacing=0 border=0 width=100% align=center class=" . $this->admin_site->get_row_color() . " >\n";
			...
			$this->admin_site->body .= "<tr>\n\t<td class=col_hdr_left><b>Image Title</b></td><td class=col_hdr_left><b>Image location (URL)</b></td></tr>\n";
			...
			if (!$this->admin_site->admin_demo())
				$this->admin_site->body .= "<tr class=" . $this->admin_site->get_row_color() . " >\n\t<td colspan=2 align=center class=medium_font>\n\t<input type=submit name=\"auto_save\" value=\"Add Image Choice\">\n\t</td>\n</tr>\n";
			$this->admin_site->body .= "\n\t</td>\n</tr>
</table></fieldset>
<fieldset>
...
<table cellpadding=3 cellspacing=0 border=0 width=100% align=center class=" . $this->admin_site->get_row_color() . " >\n";
			...
			$this->admin_site->body .= "<tr>\n\t<th class=col_hdr_left>Tag</td><th class=col_hdr_left>Description</td></tr>\n";
	...
	function display_addon_flyers () 
	{
		...
		elseif ($result->RecordCount() == 1)
		{
			$this->admin_site->body .= $admin->getUserMessages();
			$show = $result->FetchRow();
			if (!$this->admin_site->admin_demo())$this->admin_site->body .= "<form action=index.php?mc=listing_setup&page=addon_flyers method=post>\n";
			$this->admin_site->body .= "
<fieldset>
<legend>Current Image Choices for Seller</legend>
<table cellpadding=3 cellspacing=0 border=0 width=100% align=center class=" . $this->admin_site->get_row_color() . " >\n";
...
<legend>Add a New Image Choice</legend>
<table cellpadding=3 cellspacing=0 border=0 width=100% align=center class=" . $this->admin_site->get_row_color() . " >\n";
			$this->admin_site->body .= "<tr>\n\t<td class=col_hdr_left><b>Image Title</b></td><td class=col_hdr_left colspan=\"2\"><b>Image location (URL)</b></td></tr>\n";
