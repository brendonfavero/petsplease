...
class addon_multi_admin_admin {
	...
	function init_pages () {				
		...
		//group manage
		menu_page::addonAddPage('addon_multi_admin_groups','','Admin Groups','multi_admin',$this->icon_image);
			menu_page::addonAddPage('addon_multi_admin_group_edit','addon_multi_admin_groups', 'Edit Group Permissions','multi_admin',$this->icon_image,'sub_page');
			menu_page::addonAddPage('addon_multi_admin_group_delete','addon_multi_admin_groups', 'Delete Group','multi_admin',$this->icon_image,'sub_page');
		
		//add extra config
		menu_page::addonAddPage('addon_multi_admin_users','','Admin Users','multi_admin',$this->icon_image);
			menu_page::addonAddPage('addon_multi_admin_user_edit','addon_multi_admin_users', 'Edit User Permissions','multi_admin',$this->icon_image,'sub_page');		
			menu_page::addonAddPage('addon_multi_admin_user_delete','addon_multi_admin_users', 'Remove Admin Rights','multi_admin',$this->icon_image,'sub_page');
	}
