...
<div style="text-align:right;"><input type="submit" name="auto_save" value="Save Changes" />
<table style="border: none; width:100%; margin-left: -1px;">
{if $special}
	<tr>
		<th class="col_hdr_top" colspan="4" style="white-space:nowrap;">Special Permissions</th>
	</tr>
	<tr>
		<th class="col_hdr_left" style="padding-right:15px;">&nbsp;</th>
		<th class="col_hdr" style="width:20px;">View</th>
		<th class="col_hdr" style="width:20px;">Edit</th>
	</tr>
	{if $no_pages}
		<tr class="medium_font_light row_color_red">
			<th colspan="4" style="text-align:left; padding-left: 5px; white-space:nowrap;">Permissions for Pages Not Found</th>
		</tr>
		{foreach from=$no_pages item="index"}
		<tr class="small_font {cycle values='row_color1,row_color2'}">
	...
	{/if}
		<tr>
			<th colspan="4" class="col_ftr" style="text-align:left; padding-left: 5px; white-space:nowrap;">Special Permissions</th>
		</tr>
	...
	{/foreach}
{/if}
	<tr><th class="col_hdr_top" colspan="4">Page Access Permissions</th></tr>
{foreach from=$top_categories item="top_category"}
	<tr>
		<th class="col_hdr_left" style="padding-right:15px; white-space:nowrap;">
			Section / Page Name
		</th>
		<th class="col_hdr_left" style="white-space:nowrap;">
			View
		</th>
		<th class="col_hdr_left" style="white-space:nowrap;">
			Edit
...
<input type="submit" name="auto_save" value="Save Changes" /></div>
