			...
			<table style="width: auto; border: 1px solid black;">
				...
				<tbody>
					...
					<tr class="col_ftr">
						...
						<td>
							<input type="text" name="tokens[expire]" id="expire" class="dateInput" value="{$smarty.now|format_date:'Y-m-d'}" style="width: 110px;" />
							<img src="admin_images/calendar_button.gif" style="vertical-align: middle;" alt="Select Date" id="expireCalButton" />
						</td>
