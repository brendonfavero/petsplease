...
class addon_zipsearch_admin extends addon_zipsearch_info
{
	public function init_pages ()
	{
		...
		menu_page::addonAddPage('zipsearch_settings','','Settings',$this->name, $this->icon_image);
		menu_page::addonAddPage('insertZipData','','Import Zip Data',$this->name, $this->icon_image);
	}
