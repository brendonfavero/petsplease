...
class addon_SEO_setup extends addon_SEO_info
{
	...
	public function enable () {
		$admin = true; include GEO_BASE_DIR . 'get_common_vars.php';
	...
	function upgrade ($from_version = false) {
		...
		//to display messages.
		$db = $admin = true; include GEO_BASE_DIR . 'get_common_vars.php';
	...
	function resetUpgradeSettings()
	{
		...
		if($seo)$seo->resetUpgradeSettings();
		return true;
	}
