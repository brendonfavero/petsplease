...
class addon_attention_getters_admin extends addon_attention_getters_info
{
	...
	function init_pages () {
		...
		menu_page::addonAddPage('listing_attention_getters_view','','Settings','attention_getters',$this->icon_image);
		menu_page::addonAddPage('listing_attention_getters_delete','listing_attention_getters_view','Delete Attention Getter','attention_getters',$this->icon_image,'sub_page');
	...
	function display_listing_attention_getters_view () {
		...
		$body .= "<fieldset id='CurAttnGtrs'>
				<legend>Current Attention Getters</legend><table cellpadding=\"3\" cellspacing=\"1\" style=\"border-style: none; margin: 0 auto;\" >\n";
		...
		{
			$body .= "<tr><td class=\"col_ftr\"><input type=\"text\" name=\"b[attention_getter_name]\" /></td>\n\t
