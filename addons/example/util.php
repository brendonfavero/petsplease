...
class addon_example_util extends addon_example_info
{
	...
	public function core_overload_Browse_ads_display_browse_result ($vars)
	{
		...
		$vars = array (
			...
			'header_css' => $header_css,		//the header_css, as passed to the original function
	...
	/**
	 * This one is called right before the contents of the {header_html} are
	...
	/**
	 * Called when the "sold" status of a classified changes
	 */
	
	public function notify_sold_sign_status_changed ($vars)
	{
		$vars = array(
...
<table cellpadding='2' cellspacing='1' style='border:0px; width:100%;'>
	...
	/**
	 * Used on listing display page, to add action buttons.
	 * These are the buttons that by default appear near the top of the page, next to the title.
	 * 
	 * @param array $vars Associative array, see method's source for full documentation.
	...
	{
		$isPreview = $vars['isPreview']; //true if this is the preview window during listing placement
