{*CODE_ONLY*}
{*
NOTE:  This template is used to display the contents of each listing "box" of 
the featured gallery that displays at the top, during normal browsing.  Since this template
...
*}
<article class="listing" style="width: {$gallery_percent}%;">
	{* 
