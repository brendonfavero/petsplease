<div class="content_box">
	...
	<p>Below you will find some default questions and answers to help get you started. You can change the text for this page and add
	or remove questions by accessing the following menu in the admin panel:<br>  
	Design &gt; Templates &gt; main_page &gt; extra_pages</p> 
	
	<h1 class="subtitle">What is the cost to register on this site?</h1>
	<p style="padding: 0 15px;">Nothing. There are no registration fees for buyers or sellers. </p>

	<h1 class="subtitle">How much does it cost for sellers to place listings? </h1>
	...
	<h1 class="subtitle">How do buyers and sellers communicate with each other? </h1>
