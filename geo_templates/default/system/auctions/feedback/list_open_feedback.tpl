		...
		<table style="width: 100%;">
			...
			{foreach from=$feedbacks item=feedback}
				<tr class="{cycle values="row_even,row_odd"}">
					...
					<td class="center"><a href="{$feedback.reply_link}" class="mini_button">{$messages.102432}</a></td>
					<td class="center"><a href="{$feedback.auction_link}" class="preview">{$messages.102433}</a></td>
				</tr>
			{foreachelse}
				<tr>
					<td colspan="6">
