...
<div class="content_box">
	...
	<div class="center">
		...
		<ul class="button_list">
			<li><a href="{$previewUrl}" onclick="window.open(this.href,'previewWindow','scrollbars=yes,status=no,width=1075,height=600'); return false;" class="button">{$messages.500483}</a></li>
