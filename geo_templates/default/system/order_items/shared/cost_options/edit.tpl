...
<div style="max-width: 100%;">
	<form action="#" method="post" style="padding: 1em; max-width: 600px;" class="cost-options-edit-form">
		...
		<input type="text" name="label" value="{$info.label}" placeholder="{$messages.502250}" maxlength="{$fields->cost_options->text_length}">
		<br /><br />
				...
				<tbody class="cost_options_edit_tbody">
					...
					{foreach $info.options as $option_id => $option}
						<tr class="cost_options_row">
							...
							<td>
								<input type="text" name="options[{$option_id}][label]" value="{$option.label}" placeholder="{$messages.502262}" value="">
							</td>
							<td style="white-space: nowrap;">
