...
<body class="print_body">
	<div class="print_shell">
		...
		<div id="header">
			...
			<div class="print_top_text">Featured at: www.MyListingsSite.com</div>
		</div>
		<!-- END HEADER -->
		...
		<div id="print_listing_info_column">
			<div id="print_description">
				<h1 class="print_title">{$description_label}</h1>		
				<div class="box_pad">
					{$description}
				</div>
			</div>
			...
			<ul class="info">
				...
				<li class="value">{$time_remaining} <span class="sub_note">({$date_ended_label} {$date_ended})</span></li>
			</ul>
