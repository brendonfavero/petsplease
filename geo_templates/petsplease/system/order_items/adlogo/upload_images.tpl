...
{if $adlogo.useStandardUploader}
	...
	<div id="adlogostandardUploadBox" style="display: none; position: relative;">
		...
		<div id="adlogo_upload_instructions_box"><p class="page_note">{$adlogo.description}</p></div>
		<div class="clr"></div>
		...
		<div class="imageBox" id="adlogonewImageBox" style="display: none;">
			...
			<div class="uploadButtonsContainer">
				...
				<input type="button" value="{$messages.500676}" disabled="disabled" id="adlogouploadButton" class="mini_button" />
			</div>
		</div>
