...
//you can optionally pass in a "parent" category, in which case the list will only contain subcategories of that category
...
if (!$client->query('core.category.list',$data)){
