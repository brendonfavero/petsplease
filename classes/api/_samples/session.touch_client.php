...
//Sample API client, that uses the core.session.touch api call to update the time on
//the given session
...
//The session id, as returned by a call to core.session.init, should be string 32 chars long
$session_id = 'abc_123';
...
if (!$client->query('core.session.touch',$data)){
