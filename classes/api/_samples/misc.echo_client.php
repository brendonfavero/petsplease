...
//is set up correctly, and to run tests.
...
$data['an_argument'] = 'This is the argument "an_argument" we sent to the echo api call.';
$data['another_argument'] = 'This is another argument.';
