...
$website = "http://cytael.dyndns.org/geo-git/geo_api.php";

//Site's API key.  You can find the site's API key on the home page in the admin.
$api_key = '46e45bb0a8cb0d03a18a6e1d297c602aa10a0021';
...
$data['end_date'] = '2014-01-01';

//call the user list api.
if (!$client->query('core.system.admin.getRevenueReport',$data)){
