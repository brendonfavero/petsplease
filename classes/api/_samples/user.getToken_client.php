...
//the plain-text password, required to get token
$user_info['password'] = '';

// - OR -
//Can un-comment next line to bypass the password check.  Made available to get
//token when password not available.  This var added in version 5.1.0
//$user_info['password_bypass']=true;
