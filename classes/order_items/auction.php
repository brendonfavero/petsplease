...
class auctionOrderItem extends _listing_placement_commonOrderItem {
	...
	public function displayInAdmin() {
		if (!geoMaster::is('auctions')) { return false; }
		return true;
	}
	...
	{
		if (!geoMaster::is('auctions')) { return; }
	...
	{
		if (!geoMaster::is('auctions') || (self::isAnonymous() && !DataAccess::getInstance()->get_site_setting('jit_registration'))) return '';
	 ...
	 * automatically done: the "live" column is set to 0, and user favourites for the listing
