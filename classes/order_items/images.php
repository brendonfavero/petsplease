...
class imagesOrderItem extends geoOrderItem {
	...
	public static function mediaDisplay ($full_step)
	{
		...
		if ((isset($_GET['useLegacyUploader']) && $_GET['useLegacyUploader']) || self::detectMobileAgent()) {
