...
class geoCron {
	...
	public function heartbeat(){
		...
		if (count($run_tasks)) $this->run($run_tasks);
	}
	...
	public function lockTask($task, $lock = true){
		...
		if ($lock){
			...
			$deadlock_time_limit = ($deadlock_time_limit)? (60 * 30): $deadlock_time_limit;//default to 30 minutes if not set
	 ...
	 * for the time shift as set in the admin.  This is an alias
	 * for geoUtil::time()
	 *
	 * @return int
	 */
