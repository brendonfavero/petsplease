...
//		$this->site->get_text();
	...
	{
		if (defined('IN_ADMIN') || $this->getCartTotal() > 0 || $this->current_step !== 'cart') {
			//do not skip cart...
			trigger_error('DEBUG CART: skipCart - in admin or cart total is > 0, not skipping cart');
			return false;
		}
	...
	public function combinedDisplay ()
	{
		...
		geoCart::getInstance()->site->display_page();
	}
