<?php 
//module_display_subscategory_navigation_4.php
/**************************************************************************
...
$tpl_vars['no_subcategory_text'] = $page->messages[2423];

$tpl_vars['column_css'] = 'subcategory_navigation_4';
if (($show_module['module_display_ad_description']) && ($tpl_vars['parent_category'])) {
	...
	$tpl_vars['parent_category_text'] = $page->messages[2424] . $parent_category_name;
