<?php 
//module_display_newest_link_3_week.php	
/**************************************************************************
...
$tpl_vars = array (
	'href' => $page->configuration_data['classifieds_file_name']."?a=11&amp;b=".$page->site_category."&amp;c=65&amp;d=3",
	'class' => 'newest_3_week_link',
	'label' => $page->messages[1212]
);
