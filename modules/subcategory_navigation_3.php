...
$tpl_vars['no_subcategory_text'] = $page->messages[2420];

$tpl_vars['column_css'] = 'subcategory_navigation_3';
if (($show_module['module_display_ad_description']) && ($tpl_vars['parent_category'])) {
	...
	$tpl_vars['parent_category_text'] = $page->messages[2421] . $parent_category_name;
