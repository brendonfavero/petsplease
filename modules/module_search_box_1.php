...
$message='';
if (isset($page->messages[500107])) $message = $page->messages[500107];
...
if ($show_module['display_category_description']) {
	...
	if ( geoPC::is_ent() ) {
		...
		if ($fields['optional_field_1']) $tpl_vars['opt1'] = true;
		if ($fields['optional_field_2']) $tpl_vars['opt2'] = true;	
		if ($fields['optional_field_3']) $tpl_vars['opt3'] = true;
		if ($fields['optional_field_4']) $tpl_vars['opt4'] = true;
		if ($fields['optional_field_5']) $tpl_vars['opt5'] = true;
		if ($fields['optional_field_6']) $tpl_vars['opt6'] = true;	
		if ($fields['optional_field_7']) $tpl_vars['opt7'] = true;
		if ($fields['optional_field_8']) $tpl_vars['opt8'] = true;	
		if ($fields['optional_field_9']) $tpl_vars['opt9'] = true;
		if ($fields['optional_field_10'])	$tpl_vars['opt10'] = true;
		if ($fields['optional_field_11'])	$tpl_vars['opt11'] = true;
		if ($fields['optional_field_12'])	$tpl_vars['opt12'] = true;
		if ($fields['optional_field_13'])	$tpl_vars['opt13'] = true;
		if ($fields['optional_field_14'])	$tpl_vars['opt14'] = true;
		if ($fields['optional_field_15'])	$tpl_vars['opt15'] = true;
		if ($fields['optional_field_16'])	$tpl_vars['opt16'] = true;
		if ($fields['optional_field_17'])	$tpl_vars['opt17'] = true;
		if ($fields['optional_field_18'])	$tpl_vars['opt18'] = true;
		if ($fields['optional_field_19'])	$tpl_vars['opt19'] = true;
		if ($fields['optional_field_20'])	$tpl_vars['opt20'] = true;
	}		
} else {
	$tpl_vars['hidden_fields'] = true;
}

$tpl_vars['addonExtra'] = geoAddon::triggerDisplay('module_search_box_add_search_fields', array ('page'=>$page, 'show_module'=>$show_module),
