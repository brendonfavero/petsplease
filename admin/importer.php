...
class admin_importer
{
	...
	public function update_do_import()
	{
		...
		geoAdmin::m('Import complete! '.$completed.' groups uploaded. If there were any errors, they will be shown here. If needed, you can click Submit to run the import again');
