...
class z_minifyLibs extends geoGettingStartedCheck
{
	/**
	 * User-readable name/title for this check
	 * @var String
	 */
	public $name = 'Enable CSS/JS Optimizations for Third-Party Libraries';
	/**
	 ...
	 * @var String
	 */
	public $description = 'If your host is capable, enable the <a href="index.php?page=design_settings&mc=design">Also Combine CSS and JS libraries</a> setting to further improve page load times.';
	...
	{	
		return (bool) DataAccess::getInstance()->get_site_setting('minifyLibs');
	}
