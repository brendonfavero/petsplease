...
.show_instructions_button {
	background: #e2e4e9 url('../{/literal}{external file="images/backgrounds/button.gif" forceDefault=1}{literal}') repeat-x center left;
}

h2.title a.show_instructions_button:hover,
.show_instructions_button:active {
	background: #b7d5f2 url('../{/literal}{external file="images/backgrounds/button_hover.gif" forceDefault=1}{literal}') repeat-x center left;
}
