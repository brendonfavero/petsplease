...
<fieldset>
	<legend>Software Support</legend>
	<div class="medium_font">
		<div style="width: 48%; display: inline-block; vertical-align: top; border-right: 1px solid #006699;">
			<div style="padding-right: 3px;">
				<div class="col_ftr">Paid Support:</div>
				
				<div class="page_note">
					{if $stats.supportLeft||$stats.supportExpire=='Never'}
						<img src="admin_images/bullet_success.gif" alt="Support Active" style="margin: 5px; vertical-align: middle; float: left;" />
				...
				<div id="paidSupport_Links" style="display: none;">
					<div style="margin-top: 10px;">
						{if $stats.supportLeft||$stats.supportExpire=='Never'}
							...
							<ul class="home_links">
								<li><a href="https://geodesicsolutions.com/client-area/task,helpdesk/tab,start_ticket" {$extrnLink}>Start New Ticket</a></li>
								<li><a href="https://geodesicsolutions.com/client-area/task,helpdesk/tab,open_tickets" {$extrnLink}>Open Tickets</a></li>
								<li><a href="https://geodesicsolutions.com/client-area/task,helpdesk/tab,closed_tickets" {$extrnLink}>Closed / Need Reply Tickets</a></li>
							</ul>
		...
		<div style="width: 49%; display: inline-block;">
			...
			<div id="freeSupport_Links" style="display: none;">
				<div style="margin-top: 10px;">
					...
					<ul class="home_links">
						<li><a href="http://geodesicsolutions.com/support/geocore-wiki/" {$extrnLink}>User Manual</a></li>
						<li><a href="https://geodesicsolutions.com/geo_user_forum/index.php" {$extrnLink}>Community Forums</a></li>
						<li><a href="https://geodesicsolutions.com/client-area.html" {$extrnLink}>Client Area</a>
					</ul>
					<br /><br />
					<div class="page_note">
