...
<div{if $needsDefaultCopy} style="display: none;"{/if}>
	<div id="designTopInfo" class="breadcrumbBorder">
		<div id="designTopInfoCreateNew">
			<a href="index.php?page=design_new_folder&amp;location={$location|escape}" class="mini_button lightUpLink" id="newFolderLinky"><img src="admin_images/icons/folder-add.png" alt="Create new Folder" title="Create new Folder" /></a>
			<a href="index.php?page=design_new_file&amp;location={$location|escape}" class="mini_button lightUpLink" id="newFileLinky"><img src="admin_images/icons/file-add.png" alt="Create new File" title="Create new File" /></a>
			<a href="index.php?page=design_upload_file&amp;location={$location|escape}" class="mini_button lightUpLink" id="uploadFileLinky"><img src="admin_images/icons/upload.png" alt="Upload" title="Upload" /></a>
			<a class="fileListLink mini_button" href="index.php?page=design_manage" id="refreshListLink"><img src="admin_images/icons/refresh.png" alt="Refresh List" title="Refresh List" /></a>
		</div>
		<ul id="breadcrumb">
