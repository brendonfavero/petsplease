...
<table class="fileListTable" cellpadding="0" cellspacing="0">
	<thead>
		<tr class="col_hdr_top">
			<th></th>
			<th style="text-align: left;">
				<a class="fileListLink col_hdr_top" href="index.php?page=design_manage&amp;location={$location|escape}&amp;sortBy=filename&amp;sortOrder={if $sortOrder==up && $sortBy==filename}down{else}up{/if}">
					Name
					{if $sortBy==filename}
			...
			{if $advMode}
				<th style="text-align: left;">
					<a class="fileListLink col_hdr_top" href="index.php?page=design_manage&amp;location={$location|escape}&amp;sortBy=size&amp;sortOrder={if $sortOrder==up && $sortBy==size}down{else}up{/if}">
						Size
						{if $sortBy==size}
			...
			{/if}
			<th style="text-align: left;">
				<a class="fileListLink col_hdr_top" href="index.php?page=design_manage&amp;location={$location|escape}&amp;sortBy=type&amp;sortOrder={if $sortOrder==up && $sortBy==type}down{else}up{/if}">
					Type
					{if $sortBy==type}
			...
			<th style="text-align: left;">
				<a class="fileListLink col_hdr_top" href="index.php?page=design_manage&amp;location={$location|escape}&amp;sortBy=modified&amp;sortOrder={if $sortOrder==up && $sortBy==modified}down{else}up{/if}">
					Last Modified
					{if $sortBy==modified}
...
{if !$locationInfo.t_set}
	{capture assign=tsetListHtml}
		<h2><span class="text_blue">main_page</span> Templates In:</h2>
		<ul>
