...
{/php}*}";
	...
	public static function convertTemplate($tpl_code, $filename)
	{
		...
		$tag_replace = array ('{body_html}','{header_html}', '{$seller_username}');
...
{/if}
	...
	public static function replace($tag, $filename)
	{
		...
		} else if (strpos($tag,'logged_in_out_html') === 0) {
		...
		} else if (strpos($tag, 'module_php_insert') === 0) {
